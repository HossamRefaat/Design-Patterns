...
namespace CommandPattern
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                while (true)
                {
                    ...
                    var commandId = int.Parse(Console.ReadLine() ?? "0");
                    ...
                    else if (commandId == 8)
                    {
                        ...
                        Console.WriteLine($"Order #{order.Id} state saved to memento at index {index}.");
                    ...
                    else if (commandId == 9)
                    {
                        ...
                        var mementoIndex = int.Parse(Console.ReadLine() ?? "0");
                        var selectedMemento = caretaker.GetMemento(mementoIndex);
                        order.RestoreStateFromMemento(selectedMemento);
                        PrintOrderDetails(order);
                    }
                    else if (commandId == 0)
                    {
        ...
        private static void ReplayMacro()
        {
            ...
            var macroId = int.Parse(Console.ReadLine() ?? "0");
